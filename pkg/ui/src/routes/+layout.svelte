...
<svelte:head>
  ...
  <link
    href="https://fonts.googleapis.com/css2?family=Freeman&family=Roboto&display=swap"
    rel="stylesheet"
  />
</svelte:head>

<div
  class="flex h-screen w-screen flex-col bg-[url($lib/assets/background.webp)] bg-cover
  bg-no-repeat"
>
